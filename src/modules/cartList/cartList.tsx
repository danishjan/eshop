...
export const CartList = () => {
  ...
  const handleRemoveCart = (items: any) =>{
    removeFromCart(items);
  }

  const totalAmount = state?.cart?.reduce((acc, curr)=>  acc + curr?.price, 0)
            ...
            <div className="justify-between mb-6 rounded-lg bg-gray-100 p-6 shadow-md sm:flex sm:justify-start">
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                <div className="mt-5 sm:mt-0">
                  ...
                  <p className="mt-1 text-xs text-gray-700">{item.discountPercentage}% off</p>
                  <p className="mt-1 text-xs text-gray-700">Price: ${item.price}</p>
                </div>
                <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                  ...
                  <div className="flex items-center space-x-4" onClick={()=>handleRemoveCart(item)}>
